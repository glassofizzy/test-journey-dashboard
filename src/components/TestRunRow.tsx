  ...
  return (
    <div className="group">
      <div 
        onClick={onToggle}
        className={cn(
          "grid grid-cols-5 gap-4 p-4 cursor-pointer border-b-[1.5px] border-black bg-white",
          "hover:bg-gray-50"
        )}
      >
        ...
        <div className="flex items-center gap-2">
          <span className={cn(
            "px-4 py-1 rounded-full text-black text-sm border-[1.5px] border-black w-28 text-center",
        ...
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-accent flex items-center justify-center border-[1.5px] border-black">
                ...
                {testRun.journey?.map((step, index) => (
                  <React.Fragment key={index}>
                    ...
                    {index < (testRun.journey?.length || 0) - 1 && (
                      <div className="w-8 h-[1.5px] bg-black min-w-[32px]"></div>
                    )}
                  </React.Fragment>
                ))}
              </div>
