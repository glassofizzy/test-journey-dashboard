      ...
      <div className="bg-white p-6 rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] max-w-2xl">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-2">
            ...
            <div>
              <span className="font-medium">Live Websites & Web Apps</span> – Public or gated, as long as you have access, we're in.
            </div>
          </div>
          ...
          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-5 w-5 text-[#bb6bd9] mt-0.5 flex-shrink-0" />
            <div>
              <span className="font-medium">Staging Environments</span> – If it's online and testable, just bring your own login credentials.
            </div>
          </div>
          ...
          <div className="flex items-start gap-2">
            <CheckCircle2 className="h-5 w-5 text-[#bb6bd9] mt-0.5 flex-shrink-0" />
            <div>
              <span className="font-medium">Prototypes</span> – Whether it's Lovable, v0, BoltNew, or a Figma link, we'll put it through its paces.
            </div>
          </div>
        </div>
